...
const bestSellingProducts = productCatalog.filter((product) => product.featured).slice(0, 8);
...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-cream-50 via-dusty-blue-300 to-cream-50 py-14 sm:py-16 lg:py-32">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Content */}
            <div className="space-y-5 sm:space-y-6 z-10">
              <div className="space-y-4">
                <p className="text-dusty-blue-600 font-semibold text-lg sm:text-xl lg:text-2xl uppercase tracking-wide italic font-serif">
                  Welcome to The Crochet Kaurner
                </p>
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-800 leading-tight italic font-serif">
                  Handmade With{' '}
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
                <Link
                  href="/products"
                  className="inline-flex w-full sm:w-auto items-center justify-center px-6 py-3 bg-slate-blue-800 text-white rounded-lg hover:bg-slate-blue-700 transition-colors duration-200 text-base sm:text-lg font-semibold"
                >
                  Shop Now
                </Link>
                <button className="w-full sm:w-auto px-6 py-3 bg-white text-gray-800 rounded-lg hover:bg-gray-100 transition-colors duration-200 text-base sm:text-lg font-semibold">
                  Learn Our Story
                </button>
              </div>

              {/* Stats */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-6 sm:pt-8 border-t border-beige-300">
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-dusty-blue-800">500+</p>
                  <p className="text-m text-gray-600">Creations Made</p>
                </div>
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-dusty-blue-800">800+</p>
                  <p className="text-m text-gray-600">Happy Customers</p>
                </div>
                <div>
                  <p className="text-2xl sm:text-3xl font-bold text-dusty-blue-800">5★</p>
            ...
            {/* Hero Image */}
            <div className="relative h-72 sm:h-96 lg:h-full min-h-[18rem] sm:min-h-96">
              ...
              <div className="absolute inset-5 sm:inset-8 bg-cream-100 rounded-2xl flex items-center justify-center text-gray-400 text-center p-5 sm:p-8">
                <div className="text-center">
                  <span className="text-5xl sm:text-6xl mb-3 sm:mb-4 block">🧶</span>
                  <span className="text-lg sm:text-xl font-medium">Handmade Crochet Items</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Decorative Elements */}
        <div className="hidden sm:block absolute top-0 right-0 w-96 h-96 bg-softPastel-lavender rounded-full opacity-20 -z-10 blur-3xl"></div>
        <div className="hidden sm:block absolute bottom-0 left-0 w-96 h-96 bg-softPastel-mint rounded-full opacity-20 -z-10 blur-3xl"></div>
      </section>

      {/* Featured Categories Section */}
      <section className="py-12 sm:py-16 lg:py-24 bg-cream-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((category) => (
              ...
              >
                <div
                  className={`bg-gradient-to-br ${category.color} to-cream-100 rounded-2xl p-6 sm:p-8 shadow-soft hover:shadow-soft-lg transition-all duration-300 hover:-translate-y-1 h-full flex flex-col justify-center items-center text-center`}
                >
                  <span className="text-5xl sm:text-6xl mb-4 group-hover:scale-110 transition-transform duration-300">
                    {category.icon}
                  </span>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-white">
        <div className="container-custom">
          <div className="text-center mb-10 sm:mb-16">
            <p className="text-dusty-blue-500 font-semibold text-lg sm:text-xl uppercase tracking-wide mb-2">
              Our Best Sellers
            </p>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
              Customer Favorites
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-beige-50">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Feature 1 */}
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-soft hover:shadow-soft-lg transition-shadow duration-300">
      ...
      {/* Final CTA Section */}
      <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-r from-slate-blue-500 to-slate-blue-600">
        <div className="container-custom text-center space-y-6">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white">
            Ready to Find Your Perfect Crochet Piece?
          </h2>
          <p className="text-base sm:text-xl text-cream-100 max-w-2xl mx-auto">
